...
| --- | --- | --- |
| `ubicloud-standard-2-ubuntu-2404` | `ubuntu-24.04` | Planning, status aggregation, dependency audit, gitleaks and actionlint |
| `ubicloud-standard-4-ubuntu-2404` | `ubuntu-24.04` | Coverage reports and Semgrep |
| `ubicloud-standard-16-ubuntu-2404` | `ubuntu-24.04` | Unit, serial, E2E, browser, compatibility, read-performance and deployment-matrix tests |
| `ubicloud-standard-30-ubuntu-2404` | `ubuntu-24.04` | Heavy test suite and persistence invariant/soak matrix |
| `ubicloud-standard-16-arm-ubuntu-2404` | `ubuntu-24.04-arm` | Native ARM64 glibc and musl tests |
